...
This Class File "MyDataTypes.java" is part of project <"just write what you want"> , which is belong to Michael Pang (It's Me).
 ...
 * @version 1.0
 * @since 2024年10月25日-2024年10月25日
 */
@MyTableOrView(name="MY_DATA_TYPES")
public class MyDataTypes {
    ...
    public String toString() {
        String s = "MyDataTypes{col1:%s, col2:%s, col3:%s, col4:%s, col5:%s, col6:%s, col7:%s, col8:%s, col9:%s, col10:%s, col11:%s, col12:%s, col13:%s, col14:%s, col15:%s, col16:%s, col17:%s, col18:%s, col19:%s, col20:%s, col21:%s, col22:%s, col23:%s, col24:%s, col25:%s, col26:%s, col27:%s, col28:%s, col29:%s, col30:%s, col31:%s, col32:%s, col33:%s, col34:%s, col35:%s, col36:%s}";
