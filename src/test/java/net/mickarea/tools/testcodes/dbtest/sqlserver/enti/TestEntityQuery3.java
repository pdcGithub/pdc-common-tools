...
public class TestEntityQuery3 {
	...
	public static void main(String[] args) {
		...
		condiList.addParam(new CondiParam("col_7", null, CondiParam.OPT_IS_NOT_NULL));
		condiList.addParam(new CondiParam("col_35", "字段", CondiParam.OPT_LIKE));
		
		//排序参数
		OrderParamList orderList = new OrderParamList();
		orderList.addParam(new OrderParam("col_1", OrderParam.OPT_ASC));
		orderList.addParam(new OrderParam("col_4", OrderParam.OPT_DESC));
