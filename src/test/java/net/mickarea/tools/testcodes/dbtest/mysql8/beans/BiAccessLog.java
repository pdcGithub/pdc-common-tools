...
This file "BiAccessLog.java" is part of project <"pdc-common-tools"> , which is belong to Michael Pang (It's Me).
 ...
 * @since 2024年7月3日
 */
@MyTableOrView(name="BI_ACCESS_LOG")
public class BiAccessLog {
    ...
    public BiAccessLog(String accessId, String accessIp, String loginUserId, String accessUrl, String accessType, String accessObjId, java.time.LocalDateTime accessTime, java.sql.Timestamp accessTimestamp) {
    ...
    public String toString() {
        String s = "BiAccessLog{accessId:%s, accessIp:%s, loginUserId:%s, accessUrl:%s, accessType:%s, accessObjId:%s, accessTime:%s, accessTimestamp:%s}";
     ...
     * @return MyBiAccessLog 对象
     */
    public MyBiAccessLog translateToMyBiAccessLog() {
    	MyBiAccessLog newLog = new MyBiAccessLog();
    	newLog.setAccessId(this.accessId);
    	newLog.setAccessIp(this.accessIp);
    	newLog.setLoginUserId(this.loginUserId);
    	newLog.setAccessUrl(this.accessUrl);
    	newLog.setAccessType(this.accessType);
    	newLog.setAccessObjId(this.accessObjId);
    	newLog.setAccessTime(this.accessTime==null?null:Timestamp.valueOf(this.accessTime));
    	newLog.setAccessTimestamp(this.accessTimestamp);
    	return newLog;
    }
}
