...
public class TestEntityQuery3 {
	...
	public static void main(String[] args) {
		...
		condiList.addParam(new CondiParam("app_date", null, CondiParam.OPT_IS_NOT_NULL));
		condiList.addParam(new CondiParam("v_clob", "FI", CondiParam.OPT_LIKE));
		
		//排序参数
		OrderParamList orderList = new OrderParamList();
		orderList.addParam(new OrderParam("cname", OrderParam.OPT_ASC));
		orderList.addParam(new OrderParam("app_date", OrderParam.OPT_DESC));
